...
System.out.println("ApplyJoinStartupsAction.java处理用户申请的ajaxAction出错！获取输出管道出错！");
		...
		StartupsTempShow sts = iss.getStartupsTempShowInId(startups);
		...
		boolean secondary = ics.canApplyContract(user.getUserId(), startups, "正在审核");
