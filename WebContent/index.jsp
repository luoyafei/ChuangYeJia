		...
		<div class="container marketing" style="background-color: white; padding:50px 0px">
			...
			<div class="thumbtitle">
				<div class="contenttitle" style="margin-bottom: 10px;">
					...
					<!-- <p class="uk-text-right">随经济全球化以及生产专业化现象的普遍，社会分工和协同合作已经成为了一种创业趋势。</p>
					<p class="uk-text-left">WHAT&nbsp;&nbsp;&nbsp;&nbsp;WE&nbsp;&nbsp;&nbsp;&nbsp;DO</p>
			...
			<div class="jumbotitle">
				<div class="container">
					<a href="/ChuangYeJia/pages/title/copartner_list.jsp" class="btn btn-lg" style="border-radius: 20px; border: solid black 2px; float: right;margin-top: 20px;margin-bottom: 20px;">更多内容</a>
				</div>
			</div>
		</div>
